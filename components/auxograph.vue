		...
		<view class="container">
			<view v-for="(item, i) in imgsArr" :key="i">
				<view class="timeline-item" v-if="i % 2 == 0">
					...
					<view class="timeline-content js--fadeInLeft"><image :src="item.resArr[0]" mode="widthFix" @tap="toPhoto(item.resArr)"></image></view>
				</view>
				...
				<view class="timeline-item" v-else>
					...
					<view class="timeline-content js--fadeInRight"><image :src="item.resArr[0]" mode="widthFix" @tap="toPhoto(item.resArr)"></image></view>
				</view>
			</view>
		</view>
	</view>
